...
const fileUpload = async(req, res = response) => {
    ...
    const validType = ['products', 'logo', 'user', 'archivos'];
    ...
    if (desc === 'archivo') {
        ...
        const validArch = ['rar', 'zip', 'eps', 'ai', 'psd'];
        ...
        if (!validArch.includes(extFile)) {
            ...
            return res.status(400).json({
                ok: false,
                msg: 'No se permite este tipo de archivo, solo extenciones ZIP - EPS - AI - PSD - RAR '
            });
        }
